...
from model.model_gat import ViG_Classifier
...
if __name__ == "__main__":
    ...
    print(len(tr_labels), len(val_labels), len(test_labels))
    ...
    # hpyerparameterss
    model = ViG_Classifier(patch_emb=256, num_blocks=2, hidden_features=512, n_classes=9, k=7, dilation=1, gat_heads=4, grid_size=8).to(device)
