...
from model.model_graphsage import ViG_Classifier
...
if __name__ == "__main__":
    ...
    model_save_path = "./checkpoints/seed_experiment/GraphSage/VIG_classification-GraphSage-k7_seed{}.pth".format(data_seed)
